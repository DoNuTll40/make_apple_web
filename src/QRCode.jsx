...
export default function QRCodeGenerate({ price }) {
    ...
    const result = generatePayload('0803931136', { amount: price })

    return (
        <div className='pb-10 flex justify-center'>
            <div className='pb-1 w-[26rem] rounded-3xl border-2 shadow-lg select-none pointer-events-none'>
